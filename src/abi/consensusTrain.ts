...
export const CONSENSUS_DATA_TRAIN_ABI = parseTrainAbi([
  ...
  "function canFinalize(bytes32 _txId, uint256 _currentTimestamp, uint256 _expectedDecisionId) view returns (bool ready, uint256 evaluatedAt, uint256 appealDeadline)",
